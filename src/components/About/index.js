...
const About = ({ data }) =>
    <div className='page'>
        ...
        <Content>
            ...
            <p>I record all my lectures on Youtube but you have to <a href='https://apply.yh-antagning.se/to/kyh/ht2020/14' target='_blank' rel="noopener noreferrer">enroll</a> in the class to get access.</p>
